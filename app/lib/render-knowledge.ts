...
function summaryCards(data: KnowledgeData) {
  const candidates = [
...
export function renderKnowledgeHtml(rawData: unknown): string {
  ...
  const summaries = summaryCards(data);
